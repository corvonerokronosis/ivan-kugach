...
Эталонные снимки актуального `index_masterskaya.html` для поэтапной Astro-миграции. Они фиксируют текущее художественное направление, геометрию экранов, responsive-поведение и состояния интерактивов; это не новая дизайн-спецификация.

## Параметры съёмки

- Дата: 2026-06-19.
- Источник: `http://127.0.0.1:4173/index_masterskaya.html`.
