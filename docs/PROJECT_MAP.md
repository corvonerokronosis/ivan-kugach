...
| `index_masterskaya.html`                   | Единственная актуальная исполняемая версия сайта               | Любое изменение текущего UI, сценариев, данных или интерактивов   |
...
| --------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------ |
| `src/`                      | Astro-код и изображения актуального прототипа                  | Новая исходная директория; изображения будут разнесены позже |
| `src/pages/`                | Файловые маршруты Astro                                        | Сейчас существует технический `/`                            |
| `src/layouts/`              | Общие Astro-layouts                                            | Сейчас существует минимальный `BaseLayout.astro`             |
| `src/for_sales/`            | Изображения каталога работ                                     | Активно используется каталогом                               |
| `src/picture_light_shadow/` | Три изображения интерактива света                              | Активно используется                                         |
...
5. Для Astro-каркаса — `package.json`, нужная страница или layout.
