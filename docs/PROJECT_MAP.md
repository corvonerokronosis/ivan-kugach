...
| `src/data/`                 | Типизированные локальные данные                                | Контент страницы художника, источники работ и серий                                  |
...
| `src/types/`                | Общие TypeScript-контракты                                     | `artwork.ts` и `series.ts`: модели работ, серий и производные типы                   |
