...
| `src/data/`                 | Типизированные локальные данные                                | Контент страницы художника и локальный источник работ               |
| `src/layouts/`              | Общие Astro-layouts                                            | `BaseLayout.astro`: metadata, skip-link и page slots                |
| `src/pages/`                | Файловые маршруты Astro                                        | Главная, художник, landing, каталог, 404, заглушки и `/ui-preview/` |
...
| `src/types/`                | Общие TypeScript-контракты                                     | `artwork.ts`: модель произведения и производные типы                |
