...
| ----- | --------- | ------- | -------------------------- | ------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R3-00 | P0        | ready   | —                          | Contract gate             | Утвердить site-wide visual и functional contract variant-3 | этот документ, локальный experiment                                                                                   | Пользователь подтверждает таблицу переноса experiment, системный font stack, сохранение текущих функций и две разрешённые новые функции; после принятия задача отмечена `done`.       |
