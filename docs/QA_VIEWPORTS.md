...
Astro-версии. Он используется в FRT-052 и FRT-053 как список обязательных
размеров, а полный последовательный проход теперь находится в
...
## Результат FRT-052 — оболочка и контентные страницы
...
## Результат FRT-054 — визуальное сравнение с legacy
...
`docs/VISUAL_BASELINE.md` на baseline-размерах `1440x900` и `390x844`.
