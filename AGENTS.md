...
6. Перед созданием Astro-файлов проверь правила в `src/README.md`.
7. `README.md` используй для краткого описания продукта и пользовательского маршрута.
...
- `docs/Frontend_Rebuild_Backlog.md` описывает будущую Astro-архитектуру, которой пока нет в репозитории.
