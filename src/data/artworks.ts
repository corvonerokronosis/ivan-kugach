...
const artworks = validateArtworks([
  {
    ...
    fullDescription: joinText(
      "Временное описание фиксирует место произведения в MVP-каталоге.",
      "После уточнения атрибуции здесь появится реальный сюжет, техника, размер и история работы Ивана Кугача.",
    ),
    featured: true,
    order: 1,
  },
  {
    ...
    fullDescription: joinText(
      "Эта карточка демонстрирует сценарий уточнения цены.",
      "Пользователь может открыть детальный просмотр и отправить заявку,",
      "не воспринимая страницу как интернет-магазин с мгновенной оплатой.",
    ),
    featured: true,
    order: 2,
  },
  {
    ...
    fullDescription: joinText(
      "Статус резерва помогает показать реальное состояние каталога.",
      "Форма может принять вопрос о сроках, похожих работах или серии, но не обещает автоматическое снятие резерва.",
    ),
    featured: false,
    order: 3,
  },
  {
    ...
    fullDescription: joinText(
      "Архивная карточка помогает понять диапазон творчества Ивана Кугача",
      "и может вести к вопросу о похожих произведениях или работах этой серии.",
    ),
    featured: false,
    order: 4,
  },
  {
    ...
    fullDescription: joinText(
      "Работа отображается отдельно от доступного каталога.",
      "CTA формулируется как интерес к похожим работам, чтобы не создавать впечатления доступности.",
    ),
    featured: false,
    order: 5,
  },
