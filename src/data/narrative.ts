    ...
    slides: [
      {
        ...
        text: joinText(
          "Посетитель входит в зал и сначала видит не механику, а настроение.",
          "Это окно задаёт тон будущей истории и объясняет,",
          "что интерактивы будут частью одного маршрута, а не двумя отдельными упражнениями.",
        ),
        secondaryText: joinText(
          "Здесь позже можно разместить короткую кураторскую ремарку о том,",
          "почему история начинается именно с возвращения цвета.",
        ),
      },
      {
        id: "intro-2",
        ...
        text: joinText(
          "Во втором окне narrative может подвести пользователя к мысли, что работа ещё не раскрылась полностью.",
          "В текущем патче здесь стоит временный текст, который просто держит структуру и ритм последовательности.",
        ),
        secondaryText:
      ...
      },
      {
        ...
        text: joinText(
          "Третье окно завершает вводный блок и подводит к действию.",
          "Пока здесь заглушка, но позже именно это место станет смысловым мостом между историей и сценой 'Возвращение цвета'.",
        ),
        secondaryText:
    ...
    slides: [
      {
        ...
        text: joinText(
          "Первое промежуточное окно должно объяснять,",
          "что восстановление живописного слоя было только первой частью путешествия.",
          "Сейчас это временный текст, который помогает собрать будущую структуру сценария.",
        ),
        secondaryText:
      ...
      },
      {
        ...
        text: joinText(
          "Во втором окне narrative может сместить фокус с общего впечатления на детали:",
          "следы времени, архитектуру, ритм фактур и малые элементы композиции.",
        ),
        secondaryText:
      ...
      },
      {
        ...
        text: joinText(
          "Финал промежуточной вставки готовит вход во второй интерактив.",
          "На этом этапе текст работает как заглушка, но структура карточки и место под будущий переход уже заложены.",
        ),
        secondaryText:
    ...
    slides: [
      {
        ...
        text: joinText(
          "Пользователь уже приблизился к фактурам и точкам внимания.",
          "Следующий шаг переносит его в условную мастерскую, где тот же взгляд проверяется светом.",
        ),
        secondaryText:
      ...
      },
      {
        ...
        text: joinText(
          "У Кугача состояние часто держится на тонкой разнице:",
          "холодный день делает видимой конструкцию, вечер собирает память, лампа приближает человеческое присутствие.",
        ),
        secondaryText:
    ...
    slides: [
      {
        ...
        text: joinText(
          "После просмотра всех точек здесь может появиться первый итоговый смысловой акцент.",
          "Пока это техническая заглушка, но экран уже рассчитан на финальную подачу истории.",
        ),
        secondaryText:
      ...
      },
      {
        ...
        text: joinText(
          "Здесь narrative уже не ведёт к новой механике, а собирает опыт пользователя в завершённую историю.",
          "Сейчас текст заполнительный, но логика финальной трёхоконной вставки уже подготовлена.",
        ),
        secondaryText:
      ...
      },
      {
        ...
        text: joinText(
          "Это финальное окно должно замыкать весь путь и возвращать пользователя на посадочную страницу.",
          "Пока оно остаётся заглушкой, но уже занимает своё место в общей narrative-системе.",
        ),
        secondaryText:
