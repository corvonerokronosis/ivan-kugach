...
const artistPageContent: ArtistPageContent = {
  ...
  quote:
    "Мир Кугача держится на тепле повседневности: в его работах важны свет, человеческое присутствие и ощущение живой, узнаваемой среды.",
  contextTitle: "Взгляд на повседневность",
  contextParagraphs: [
    "Эта страница собирает художественный контекст вокруг уже представленных в проекте работ. Пока биографические сведения проходят редакционное уточнение, здесь остаются только подтверждённые наблюдения о языке живописи.",
    "Композиция построена так, чтобы позднее дополнить материал датами, источниками и авторской цитатой без изменения структуры страницы.",
  ],
  themes: [
    {
      title: "Тихий сюжет",
